...
class DateTimeTzImmutableType extends Type
{
     ...
     *
     * <code>
     * $value = Type::getType(Type::DATETIMETZ_IMMUTABLE_TYPE)
     *   ->setFormat('Y-m-d\TH:i:s.u')
     *   ->convertToPHPValue($value);
     *
     * // $value = '2018-10-05T14:48:01.017Z'; // return '2018-10-05 14:48:01.017000';
